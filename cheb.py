...
class Net(torch.nn.Module):
    def __init__(self):
        ...
        k = 2
        self.conv1 = ChebConv(dataset.num_node_features, hidden_size[0], k)
        self.conv2 = ChebConv(hidden_size[0], hidden_size[1], k)
        self.conv3 = ChebConv(hidden_size[1], hidden_size[2], k)
        self.conv4 = ChebConv(hidden_size[2], hidden_size[3], k)
        self.conv5 = ChebConv(hidden_size[3], hidden_size[4], k)
        self.conv6 = ChebConv(hidden_size[4], hidden_size[5], k)
        self.conv7 = ChebConv(hidden_size[5], hidden_size[6], k)
        self.conv8 = ChebConv(hidden_size[6], hidden_size[7], k)
        self.conv9 = ChebConv(hidden_size[7], hidden_size[8], k)
        self.conv10 = ChebConv(hidden_size[8], hidden_size[9], k)
