...
class Net(torch.nn.Module):
    def __init__(self):
        ...
        # deep gcn
        n_kernels = 3
        hidden_size = [32, 64, 64, 128, 64, 64]
        self.edge_fc1 = nn.Linear(2, 16*32)
        self.conv1 = NNConv(16, 32, self.edge_fc1)
        self.edge_fc2 = nn.Linear(2, 32*64)
        self.conv2 = NNConv(32, 64, self.edge_fc2)
        self.edge_fc3 = nn.Linear(2, 64*64)
        self.conv3 = NNConv(64, 64, self.edge_fc3)
        self.edge_fc4 = nn.Linear(2, 64*128)
        self.conv4 = NNConv(64, 128, self.edge_fc4)
        self.edge_fc5 = nn.Linear(2, 128*64)
        self.conv5 = NNConv(128, 64, self.edge_fc5)
